    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div class="user-box">
                    <div class="user-img">
                        <img src="{{ asset('uploads/profile_photos') . '/' . Auth::user()->profile_photo }}" alt="user-img"
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        @if (Auth::user()->role == 2)
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Vendor</span> <span
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Coupon</span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span> Category</span>
                        ...
                        @if (Auth::user()->role == 3)
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span>Product</span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
        ...
        <div class="content-page">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                ...
                                <div class="dropdown-item noti-title">
                                    <h5 class="m-0"><span class="float-right"><a href=""
                                                class="text-dark"><small>Clear All</small></a> </span>Notification</h5>
                                </div>
            ...
            <footer class="footer text-right">
                {{ \Carbon\Carbon::today()->format('Y') }} © Rabeya_lily.Code.com
            </footer>
