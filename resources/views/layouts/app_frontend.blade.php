                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ carttotalproduct() }}</span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product_photos')}}/{{ App\Models\Product::find($wishlist->product_id)->product_photo}}"
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product_photos')}}/{{$allcart->relationtoproduct->product_photo}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{$allcart->relationtoproduct->product_name }}</a>
                            <span class="quantity-price">{{ $allcart->amount }} x <span class="amount">{{$allcart->relationtoproduct->product_price }}</span></span>
                            <span>${{$allcart->amount *$allcart->relationtoproduct->product_price  }}</span>
