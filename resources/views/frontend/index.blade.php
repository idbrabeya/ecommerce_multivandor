                        ...
                        <ul class="product-tab-nav nav align-items-center justify-content-center">
                            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab"
                              ...
                              <li class="nav-item m-1"><a class="nav-link" data-bs-toggle="tab"
                                href="#tab-product-{{$categories->category_name }}">{{$categories->category_name }}</a></li>
                              @endforeach
                        </ul>
                    </div>
                    <!-- Tab End -->
        ...
        <div class="row">
            <div class="col">
                <div class="tab-content mb-30px0px">
                   ...
                   <div class="tab-pane fade" id="tab-product-{{$categories->category_name }}">
                    <div class="row">
                        @forelse (App\Models\Product::where('category_id',$categories->id)->get() as $all_products)
                        @include('parts.product_thuem')
            ...
            <div class="single-banner-2">
                ...
                <div class="item-disc">
                    <h4 class="title">{{ $categories->category_tagline }} <br>
                       {{$categories->category_name}}</h4>
                    <a href="{{ route('categorywise.products',$categories->id) }}" class="shop-link btn btn-primary ">Shop Now <i
